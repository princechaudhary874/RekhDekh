...
class ServiceListPage extends StatelessWidget {
  final List<Map<String, dynamic>> services = [
    ...
    },
    {
      ...
      'image': 'assets/blood_donation.jpg',
...
class NearbyHospitalPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Image.asset('assets/hospital_details.jpg', height: 200, fit: BoxFit.cover),
          Padding(
...
class BloodDonationPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Image.asset('assets/blood_donation_details.jpg', height: 200, fit: BoxFit.cover),
          Padding(
            padding: const EdgeInsets.all(16.0),
            child: Text(
...
class AmbulanceTrackingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Image.asset('assets/ambulance_details.jpg', height: 200, fit: BoxFit.cover),
          Padding(
            padding: const EdgeInsets.all(16.0),
            child: Text(
...
class InsuranceServicePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Image.asset('assets/insurance_details.jpg', height: 200, fit: BoxFit.cover),
          Padding(
            padding: const EdgeInsets.all(16.0),
            child: Text(
...
class HomeLabTestPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Image.asset('assets/lab_test_details.jpg', height: 200, fit: BoxFit.cover),
          Padding(
            padding: const EdgeInsets.all(16.0),
            child: Text(
...
class PharmacyServicePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Image.asset('assets/pharmacy_details.jpg', height: 200, fit: BoxFit.cover),
          Padding(
            padding: const EdgeInsets.all(16.0),
            child: Text(
